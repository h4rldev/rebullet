...
## Contributing
🎉 Directly send PRs! Make sure development is done and tested in `Python >= 3.6` <br> :exclamation_point: And make sure to make them mergable to save me and you time :).
